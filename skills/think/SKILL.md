...
when_to_use: "what's the best approach, plan this, how should I, should we keep this"
...
Activate when the user wants to judge whether something should exist, be kept, exposed, or removed. Typical triggers: "should we keep this", "is this worth it", .
...
| User said and got Evaluation Mode | + error/bug context = debugging, route to `/hunt`. Evaluation Mode is for value/existence judgments only |
