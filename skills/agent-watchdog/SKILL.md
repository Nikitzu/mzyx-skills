---
name: agent-watchdog
description: "Audits another agent's work — a Codex session, Claude Code transcript, PR, branch, CI run, or pasted summary — against what was actually asked. Use for cross-agent handoffs and unattended runs. Not for reviewing your own in-session diff (use check or code-review-and-quality)."
when_to_use: "watch this agent, babysit the run, audit what codex did, did it actually finish, check the other agent's work, does this branch match the ask"
