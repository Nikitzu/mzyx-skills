...
description: "Keeps long-running or parallel agent work inside the 5-hour and weekly usage windows — checks usage between waves, pauses at 95%, and schedules a self-contained resume. Use before and during multi-wave subagent work. Not for pacing a single short task."
when_to_use: "usage limit, running out of tokens, weekly limit, pause until the window clears, long overnight run, before spawning many agents"
