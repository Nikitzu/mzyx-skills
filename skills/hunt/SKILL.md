...
when_to_use: "debug, regression, used to work, broke after update, why broken, not working, what's wrong, fix error, stack trace"
...
Activate when: "used to work", "broke after update", or the user remembers a specific good commit or version.
...
1. List every reported and visible symptom, preserving the user's concrete words where useful ("still slow", "not clear", ).
